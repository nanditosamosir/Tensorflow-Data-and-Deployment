...
const MNIST_IMAGES_SPIRTE_PATH =
...
export class MnistData {
  ...
  async load() {
    // Make a request for the MNUST sprited image
    ...
    const imgRequest = new Promise((resolve, reject) => {
        ...
        (img.onload = () => {
          ...
          for (let i = 0; i < NUM_DATASET_ELEMENTS / chunkSize; i++) {
            ...
            for (let j = 0; j < imageData.data.length / 4; j++) {
              ...
              datasetBytesView[j] = image.Data.data[j * 4] / 255;
            }
          }
      ...
      img.src = MNIST_IMAGES_SPIRTE_PATH;
    });
